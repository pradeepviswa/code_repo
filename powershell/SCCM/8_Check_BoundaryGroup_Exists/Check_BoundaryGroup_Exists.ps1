...
foreach($line in $lines){
    ...
    if($existing.count -gt 0){
        ...
        foreach($e in $existing){
            ...
            Write-Host "$name `t $DefaultSiteCode" -ForegroundColor Yellow
        }
...
Send-MailMessage -Attachments $outfile -To "hs-sysadmin-windows-offshore@trizetto.com" -Subject "SCCM Boundary Checked" -From "sccm@trizetto.com" -SmtpServer "mail-2.trizetto.net"
